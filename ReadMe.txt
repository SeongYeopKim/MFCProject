부가자료 폴더에 실행파일이 있습니다. 간단히 실행볼 수 있습니다.
================================================================================
    MFC 라이브러리 : 1121Pro2 프로젝트 개요
================================================================================

응용 프로그램 마법사에서 이 1121Pro2 응용 프로그램을 
만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 
프로그램작성을 위한 기본 구조를 제공합니다.

이 파일에는 1121Pro2 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.
...
1121Pro2.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CMy1121Pro2App 응용 프로그램
    클래스를 선언합니다.

1121Pro2.cpp
    응용 프로그램 클래스 CMy1121Pro2App이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\1121Pro2.ico
    ...
    주 리소스 파일인 1121Pro2.rc에 의해 포함됩니다.
...
1121Pro2Doc.h, 1121Pro2Doc.cpp - 문서
    이 파일에는 CMy1121Pro2Doc 클래스가 들어 있습니다. 이 파일을 편집하여
    특수한 문서 데이터를 추가하고 CMy1121Pro2Doc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

1121Pro2View.h, 1121Pro2View.cpp - 문서 뷰
    이 파일에는 CMy1121Pro2View 클래스가 들어 있습니다.
    CMy1121Pro2View 개체는 CMy1121Pro2Doc 개체를 보는 데 사용됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 1121Pro2.pch와
